...
class Lambdasian {
  ...
  speak() {
    return `Hello my name is ${this.name}, ${this.age} and ${this.location} properties on the instance.`
  }
...
// const teacher = new Instructor(attributes)
...
const attributes = {
  ...
  favLanguage: "python",
  catchPhrase: "fuck",
  gradClassName: "Fill in blank",
  favInstructor: "John"
}

const vanessa = new ProjectManager(attributes)
